...
class ConfigurePkgForNodeJsVerb(VerbExtension):
    """Configure ROS2 package as Node.js package."""
    ...
    def main(self, *, args):
        ...
        if os.path.exists(os.path.join(cwd, 'package.json')):
            print(f'  Current directory {cwd} already contains a NodeJS package.json file.')
            return ERROR_RETURN
...
def _get_template_dir_path(args):
    if args.template_location:
        ...
        full_package = 'ros2pkg_configure_nodejs.resource.templates' #+ language_folder
